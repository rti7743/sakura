...
//		m_pShareData->m_Common.m_bRulerDisp = TRUE;					/* ルーラー表示 */
		...
		m_pShareData->m_Common.m_sWindow.m_bCustomFont = false;
		wcscpy(m_pShareData->m_Common.m_sWindow.m_szDialogFont, to_wchar(lfIconTitle.lfFaceName));
		m_pShareData->m_Common.m_sWindow.m_nDialogFontSize = nIconPointSize / 10; // (1/10)pt => pt
